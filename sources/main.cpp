...
int main(int argc, char** argv)
{
   ...
   planetes[Uranus] = Cinematique(2.88822e9, 7.85465e8, -3.45006e7, -1.58703e5, 5.40334e5, 4.044695e3);
...
svg::Polyline vector_to_polyline(std::vector<Coord<3> > vect)
{
   ...
   for(int i=0, n=vect.size() ; i < n ; i+=5000)
      {res << svg::Point(vect[i][0]/10e6, vect[i][1]/10e6);
